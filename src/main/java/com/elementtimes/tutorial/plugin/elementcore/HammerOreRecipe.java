...
public class HammerOreRecipe {
    ...
    private static final String logOreName = "logWood";
    ...
    public static void parser(ASMDataTable.ASMData data, ECModContainer container) {
        ...
        if (logOreName.equals(ore)) {
            ...
            ECUtils.recipe.collectOneBlockCraftingResult(null, "logWood", itemStacks);
            ...
            public NonNullList<ItemStack> getRemainingItems(InventoryCrafting inv) {
                ...
                for (int i = 0; i < ret.size(); i++) {
                    ...
                    if (stack.getItem() == ElementtimesItems.smallHammer || stack.getItem() == ElementtimesItems.bigHammer) {
                        stack.getOrCreateSubCompound(modid + "_bind").setInteger("damage", damage);
                    }
