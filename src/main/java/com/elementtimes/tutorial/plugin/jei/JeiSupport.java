...
public class JeiSupport implements IModPlugin {
    ...
    public void registerCategories(IRecipeCategoryRegistration registry) {
        ...
        registry.addRecipeCategories(new MachineRecipeCategory(guiHelper, ID_COMPRESSOR, "compressor"));
        registry.addRecipeCategories(new MachineRecipeCategory(guiHelper, ID_REBUILD, "rebuild"));
        registry.addRecipeCategories(new MachineRecipeCategory(guiHelper, ID_PULVERIZE, "pulverize"));
    }
