...
public class BlockUtil {
    ...
    public static BiMap<Class, IStateMapper> sModelMapperMap = HashBiMap.create();
    ...
    public static ItemMultiTexture getMultiBlockItem(Block block) {
        if (!sTextureBiMap.containsKey(block.getClass())) {
            ...
            try {
                item.setCreativeTab((CreativeTabs) Elements.get(Class.forName(sCreativeTabsMap.get(block.getClass()))));
