...
public class RubberSapling extends BlockBush implements IGrowable {
    ...
    public void grow(World worldIn, Random rand, BlockPos pos, IBlockState state) {
        ...
        WorldGenerator worldgenerator = rand.nextInt(10) == 0 ?
                ...
                new WorldGenTrees(true, 4,
                        ElementtimesBlocks.rubberLog.getDefaultState(),
                        ElementtimesBlocks.rubberLeaf.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, true).withProperty(BlockLeaves.DECAYABLE, true),
                        false);
