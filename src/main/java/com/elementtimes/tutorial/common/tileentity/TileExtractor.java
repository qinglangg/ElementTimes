    ...
    public static void init() {
        if (RECIPE.getMachineRecipes().isEmpty()) {
            RECIPE  .newRecipe()
            		...
            		.newRecipe()
            		.addCost(5000)
            		.addItemInput(IngredientPart.forItem(Items.MAGMA_CREAM, 1))
            		.addItemOutput(IngredientPart.forItem(Items.SLIME_BALL, 1))
            		.addItemOutput(IngredientPart.forItem(Items.BLAZE_POWDER, 1))
            		.endAdd()
                    .newRecipe()
                    .addCost(2000)
