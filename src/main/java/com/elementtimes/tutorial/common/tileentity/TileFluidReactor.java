    ...
    public static void init() {
        if (RECIPES == null) {
            RECIPES = new MachineRecipeHandler()
                    ...
                    .addFluidInput(IngredientPart.forFluid(FluidRegistry.LAVA, Fluid.BUCKET_VOLUME))
                    .addItemInput(IngredientPart.forItem(Items.APPLE, 1))
                    .addFluidOutput(IngredientPart.forFluid(ElementtimesFluids.steam, Fluid.BUCKET_VOLUME))
                    .addFluidOutput(IngredientPart.forFluid(ElementtimesFluids.ammonia, Fluid.BUCKET_VOLUME))
                    .addFluidOutput(IngredientPart.forFluid(ElementtimesFluids.calciumHydroxide, 100))
                    .endAdd()
                    .newRecipe("test1")
                    .addCost(1000)
                    .addFluidInput(IngredientPart.forFluid(FluidRegistry.LAVA, Fluid.BUCKET_VOLUME))
                    ...
                    .addFluidOutput(IngredientPart.forFluid(ElementtimesFluids.diluteSulfuricAcid, Fluid.BUCKET_VOLUME))
                    .addFluidOutput(IngredientPart.forFluid(ElementtimesFluids.calciumHydroxide, 100))
                    .endAdd();
        }
    }
