...
import com.elementtimes.elementtimes.common.block.machine.TileSolidCentrifuge;
...
public class SolidCentrifugeData extends BaseGuiData<TileSolidCentrifuge> {

    public static final SolidCentrifugeData INSTANCE = new SolidCentrifugeData();

    public SolidCentrifugeData() {
        super(Industry.solidCentrifuge);
    }
