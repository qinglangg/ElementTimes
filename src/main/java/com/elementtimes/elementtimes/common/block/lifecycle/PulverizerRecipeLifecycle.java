...
import com.elementtimes.elementtimes.common.block.recipe.PulverizerRecipe;
import com.elementtimes.elementtimes.config.Config;



public class PulverizerRecipeLifecycle extends BaseTeRecipeLifecycle<PulverizerRecipe> {

    public PulverizerRecipeLifecycle(BaseTileEntity tile) {
        super(PulverizerRecipe.TYPE, tile);
    }
    ...
    protected int getEnergySpeed() {
        return Config.pulverizerSpeed.get() * getInterval();
    }
