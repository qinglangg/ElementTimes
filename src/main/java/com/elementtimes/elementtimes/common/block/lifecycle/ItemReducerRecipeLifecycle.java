...
import com.elementtimes.elementtimes.common.block.recipe.ItemReducerRecipe;



public class ItemReducerRecipeLifecycle extends BaseTeRecipeLifecycle<ItemReducerRecipe> {

    public ItemReducerRecipeLifecycle(BaseTileEntity tile) {
        super(ItemReducerRecipe.TYPE, tile);
    }
