...
public class ElectrolyticCellRecipe extends BaseRecipe {

    public static final BaseRecipeType<ElectrolyticCellRecipe> TYPE = new BaseRecipeType<ElectrolyticCellRecipe>() {};
    ...
    public ElectrolyticCellRecipe(int energy, String name, FluidStack input, FluidStack output0, FluidStack output1) {
        super(energy, 0f,
                NonNullList.create(),
                NonNullList.create(),
                NonNullList.withSize(1, new FluidStackIngredient(input)),
                output(output0, output1, FluidStack.EMPTY),
                TYPE, new ResourceLocation(ElementTimes.MODID, name));
    }

    public ElectrolyticCellRecipe(int energy, String name, FluidStack input, FluidStack output0, FluidStack output1, FluidStack output2) {
        super(energy, 0f,
                NonNullList.create(),
                NonNullList.create(),
                NonNullList.withSize(1, new FluidStackIngredient(input)),
