...
import com.elementtimes.elementtimes.common.block.machine.TilePumpAir;
...
public class PumpAirData extends BaseGuiData<TilePumpAir> {

    public static final PumpAirData INSTANCE = new PumpAirData();

    public PumpAirData() {
        super(Industry.pumpAir);
    }
