...
import com.elementtimes.elementtimes.common.block.recipe.CondenserRecipe;



public class CondenserRecipeLifecycle extends BaseTeRecipeLifecycle<CondenserRecipe> {

    public CondenserRecipeLifecycle(BaseTileEntity tile) {
        super(CondenserRecipe.TYPE, tile);
    }
