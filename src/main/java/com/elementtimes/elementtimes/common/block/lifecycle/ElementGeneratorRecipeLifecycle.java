...
import com.elementtimes.elementtimes.common.block.recipe.ElementGeneratorRecipe;
import com.elementtimes.elementtimes.config.Config;



public class ElementGeneratorRecipeLifecycle extends BaseTeRecipeLifecycle<ElementGeneratorRecipe> {

    public ElementGeneratorRecipeLifecycle(BaseTileEntity tile) {
        super(ElementGeneratorRecipe.TYPE, tile);
    }
