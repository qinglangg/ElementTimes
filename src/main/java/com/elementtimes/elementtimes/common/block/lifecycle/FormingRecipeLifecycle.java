...
import com.elementtimes.elementtimes.common.block.recipe.FormingRecipe;
import com.elementtimes.elementtimes.config.Config;



public class FormingRecipeLifecycle extends BaseTeRecipeLifecycle<FormingRecipe> {

    public FormingRecipeLifecycle(BaseTileEntity tile) {
        super(FormingRecipe.TYPE, tile);
    }
