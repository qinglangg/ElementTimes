...
import com.elementtimes.elementtimes.common.block.recipe.RebuildRecipe;
import com.elementtimes.elementtimes.config.Config;



public class RebuildRecipeLifecycle extends BaseTeRecipeLifecycle<RebuildRecipe> {

    public RebuildRecipeLifecycle(BaseTileEntity tile) {
        super(RebuildRecipe.TYPE, tile);
    }
    ...
    protected int getEnergySpeed() {
        return Config.rebuildSpeed.get() * getInterval();
    }
