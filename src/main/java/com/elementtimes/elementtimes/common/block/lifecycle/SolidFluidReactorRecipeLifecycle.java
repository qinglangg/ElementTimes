...
import com.elementtimes.elementtimes.common.block.recipe.SolidFluidReactorRecipe;



public class SolidFluidReactorRecipeLifecycle extends BaseTeRecipeLifecycle<SolidFluidReactorRecipe> {

    public SolidFluidReactorRecipeLifecycle(BaseTileEntity tile) {
        super(SolidFluidReactorRecipe.TYPE, tile);
    }
