...
import static com.elementtimes.elementcore.api.utils.CollectionUtils.*;



public class CoagulatorBucketLifecycle extends BaseTeBucketTransferLifecycle {

    private final int[] inputs = array(0);
    
    public CoagulatorBucketLifecycle(BaseTileEntity tile) {
        super(tile);
    }
