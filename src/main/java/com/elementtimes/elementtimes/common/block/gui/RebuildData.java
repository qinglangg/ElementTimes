...
import com.elementtimes.elementtimes.common.block.machine.TileRebuild;
...
public class RebuildData extends BaseGuiData<TileRebuild> {

    public static final RebuildData INSTANCE = new RebuildData();

    public RebuildData() {
        super(Industry.rebuild);
    }
