...
import com.elementtimes.elementtimes.common.block.recipe.ElectrolyticCellRecipe;



public class ElectrolyticCellRecipeLifecycle extends BaseTeRecipeLifecycle<ElectrolyticCellRecipe> {

    public ElectrolyticCellRecipeLifecycle(BaseTileEntity tile) {
        super(ElectrolyticCellRecipe.TYPE, tile);
    }
