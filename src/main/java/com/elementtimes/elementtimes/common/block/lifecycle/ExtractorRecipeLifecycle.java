...
import com.elementtimes.elementtimes.common.block.recipe.ExtractorRecipe;
import com.elementtimes.elementtimes.config.Config;



public class ExtractorRecipeLifecycle extends BaseTeRecipeLifecycle<ExtractorRecipe> {

    public ExtractorRecipeLifecycle(BaseTileEntity tile) {
        super(ExtractorRecipe.TYPE, tile);
    }
    ...
    protected int getEnergySpeed() {
        return Config.extractorSpeed.get() * getInterval();
    }
